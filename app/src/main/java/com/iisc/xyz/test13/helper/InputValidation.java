package com.iisc.xyz.test13.helper;
...
public class InputValidation {
    ...
    public boolean isInputEditTextFailed(TextInputEditText textInputEditText, TextInputLayout textInputLayout, String message)
    {
